...
#make the traveltimetbl file into a matrix (rownames and colomn names are the universities, exactly like in df_ego, remove Universiteit.22)
#no need to do it for universiteit 22 and 24, as independent variable i can see it as timeconstant. 
# remove authors with many missing data.

#write looping code, first row 1: how many authors, than col, for 1:how many authors
#in same code, loop and  match with time distance table to correct time, zie schrift.
