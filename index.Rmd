...
Hello and welcome to my labjournal, an assignment produced as part of the Social Networks course. In this labjournal, you will find 'My Journal', which features my weekly progress of learning the why, what and how of social network analysis. You will also find 'My final assignment', which holds the final product of the course: a complete social networks paper.
